                ...
                <form class="container-fluid">
                    <div class="row">
                        <table class="table table-borderless table-vpaddingless">
                            <tr>
                                <td style="width: 30%">
                                    <p><?= l('Укажите отправную точку (локацию), при перемещении на которую будет автоматически
                                формироватся логистическая цепочка') ?></p>
                                </td>
                                <td></td>
                                <td style="width: 30%">
                                ...
                                <td></td>
                                <td style="width: 30%">
                                    <p><?= l('Укажите точку назначения (локацию), при перемещении на которую будет закрываться
                                логистическая цепочка') ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
