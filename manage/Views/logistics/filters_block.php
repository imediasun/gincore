<form role="form" class="form-inline">
    <div class="form-group col-md-2 p-l-n">
    ...
    <div class="form-group col-md-2 p-l-n">
        ...
        <input type="text" name="number" class="form-control" style="width: 100%"
               value="<?= $number?>" placeholder="<?= l('Номер заказа или изделия') ?>">
    </div>

    <div class="col-md-2 p-l-n">
        <button onclick="send_get_form(this)" class="btn btn-primary"><i class="fa fa-filter"></i>&nbsp;&nbsp; <?= l('Фильтровать') ?></button>
    </div>

    <div class="col-md-2 m-t-xs p-l-n">
        <div class="checkbox">
            <label>
