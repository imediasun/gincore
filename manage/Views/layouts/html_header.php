...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?= $assetsDir ?>css/main.css?28">
    ...
    ?>
        <script src="<?= $assetsDir ?>assets/scripts.js?20"></script>
    <link rel="stylesheet" type="text/css" href="<?= $assetsDir ?>assets/styles.css?20"/>
    <?php endif; ?>
    ...
    <script type="text/javascript" src="<?= $assetsDir ?>js/main.js?50"></script>
</head>
