...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?= $assetsDir ?>css/main.css?14">
    ...
    ?>
        <script src="<?= $assetsDir ?>assets/scripts.js?11"></script>
    <link rel="stylesheet" type="text/css" href="<?= $assetsDir ?>assets/styles.css?11"/>
    <?php endif; ?>
    ...
    <script type="text/javascript" src="<?= $assetsDir ?>js/main.js?33"></script>
</head>
