...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?= $assetsDir ?>css/main.css?3">
    ...
    <script type="text/javascript">
        ...
        if (!c) {
            document.writeln('<?= l("В вашем браузере запрещены всплывающие окна. Система не может полноценно работать") ?>');
        }
    </script>
    {-css-module}
