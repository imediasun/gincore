<form method="post" class="<?= $isAjax ? '' : 'backgroud-white p-sm' ?>">
    ...
    <div class="emulate_form ajax_form" data-callback="select_typeahead_device" data-method="post"
         data-action="<?= $this->all_configs['prefix'] ?>products/ajax/?act=create_new" class="backgroud-white p-sm">
        <?php endif; ?>
        <fieldset>
            ...
            <?php if ($this->all_configs['oRole']->hasPrivilege('external-marketing')): ?>
                <div class="form-group">
                    <label class="control-label"><?= l('Розничная цена') ?> (<?= viewCurrency('shortName') ?>): </label>
                    <div class="controls">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    <select class="multiselect input-small form-control" multiple="multiple" name="categories[]">
