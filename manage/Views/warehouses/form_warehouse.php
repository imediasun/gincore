        ...
        <div class='panel-body'>
            <form method='POST'>
                ...
                <div class='form-group'>
                    ...
                    <?= $this->view->renderFile('warehouses/warehouses_groups', array(
                        'warehouse' => $warehouse,
                        'groups' => $groups
                    )) ?>
                </div>
                <div class='form-group'>
                    ...
                    <?= $this->view->renderFile('warehouses/warehouses_types', array(
                        'warehouse' => $warehouse,
                        'types' => $types
                    )) ?>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <?= $this->view->renderFile('warehouses/warehouses_locations', array(
