<?php if ($orders): ?>
    <?php foreach ($orders as $order): ?>
        ...
        <div class="gcw_status_order">
            ...
            <p><b><?= l('Устройство') ?></b>: <?= htmlspecialchars($order['title']) ?></p>
            <p><b><?= l('Серийный номер') ?></b>: <?= htmlspecialchars($order['serial']) ?></p>
                ...
                <table class="gcw_table gcw_table_stripped">
                    ...
                    <?php foreach ($order['comments'] as $comment): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars(wordwrap($comment['text'], 25, " ", true)) ?></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
