...
class BCGDrawing {
    ...
    public function finish($image_style = self::IMG_FORMAT_PNG, $quality = 100) {
        ...
        }/* elseif ($image_style === self::IMG_FORMAT_SVG) {}*/
    ...
    /*public function getBarcodeSVGcode($code) {
        ...
        $svg .= '<svg width="" height="" version="1.1" xmlns="http://www.w3.org/2000/svg">' . "\n";
        $svg .= "\t" . '<desc>' . strtr($this->barcode_array['code'], $repstr) . '</desc>' . "\n";
        $svg .= "\t" . '<g id="elements" fill="black" stroke="none">' . "\n";
