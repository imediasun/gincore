...
class Configs {
    ...
    ////- хиты продаж
            ...
            'order-status-new'                  =>  0, // новый заказ (принят в ремонт)
            'order-status-diagnosis'            =>  2, // На диагностике
    ...
    //        'order-statuses-orders'             =>  array(25, 35, 40),
            ...
            'order-statuses-manager'            =>  array(0, 2, 5, 10, 27, 30, 45), //по каким статусам выбирать заказы в менеджер заказов
            ...
            'order-status'  =>  array(
                0   => array('name' => l('Принят в ремонт'), 'color' => 'B05DBB', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                2   => array('name' => l('На диагностике'), 'color' => 'B05D55', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                5   => array('name' => l('В процессе ремонта'), 'color' => '414CD2', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                10  => array('name' => l('Ожидает запчастей'), 'color' => '90C8EE', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                15  => array('name' => l('Клиент отказался'), 'color' => 'F04544', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                20  => array('name' => l('Не подлежит ремонту'), 'color' => 'C18BA6', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                25  => array('name' => l('Выдан без ремонта'), 'color' => 'FF9C49', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                27  => array('name' => l('На согласовании'), 'color' => '7ca319', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                30  => array('name' => l('В удаленном сервисе'), 'color' => '0A0E16', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                35  => array('name' => l('Готов'), 'color' => '787987', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                40  => array('name' => l('Выдан'), 'color' => '76C572', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                45  => array('name' => l('Принят на доработку'), 'color' => 'CFAFE7', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
                50  => array('name' => l('Переведен в донор'), 'color' => 'AC5359', 'from' => array(0, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50)),
            ),
