            ...
            if ($images) {
                foreach ($images as $image) {
                    if (isset($goods[$image['goods_id']])) {
                        ...
                        $goods[$image['goods_id']][$isset($goods[$image['goods_id']], 'Фото ')] = $url . rawurlencode($image['image']);
                    }
                }
            }
        }
            ...
            if ($categories) {
                foreach ($categories as $category) {
                    if (isset($goods[$category['goods_id']])) {
                        $goods[$category['goods_id']][$isset($goods[$category['goods_id']], 'Категория ')] = $category['title'];
                    }
                }
            }
        }
