...
(function ($){
    ...
    var defaults = {
        ...
        , classChildRowPrefix: "sub-"         // define the "" css class
        ...
        , textCollapse: "Collapse All"    // the text to show when collapse all
        , onLoad: function(do_collapsible) {
            do_collapsible();
        }
            ...
            $a.bind("click", function (){
                ...
                var do_collapsible = function() {
                    ...
                    while( $trc.hasClass(settings.classChildRow) ){
                        ...
                        var method = bIsCollapsed ? settings.fx.hide : settings.fx.show;

                        if (method == 'show' && $trc.hasClass(settings.classChildRowPrefix + '' + settings.classChildRow)
                            && settings.classChildRowPrefix != '' ) {
                            //
                        } else {
                            $("td", $trc)[method]();
                            if (method == 'hide') {
                                $trc.find("a." + settings.classExpand).removeClass(settings.classExpand).addClass(settings.classCollapse);
                            }
                        }
                        // get the next row
                        $trc = $trc.next();
                ...
                settings.onLoad(do_collapsible, $tr, $self);
