...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        dragText: 'Переместите файлы сюда для загрузки',
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="btn btn-primary qq-upload-button">{uploadButtonText}</div>' : '') +
        ...
        extraMessages: {
            ...
            tooManyFilesError: 'To many files error'
        },
