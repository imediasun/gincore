				...
				F.wrap.bind('mousewheel.fb', function (e, delta, deltaX, deltaY) {
					...
					if (delta !== 0 && !canScroll) {
                        ...
                        if(isTouch){
                            ...
                            F.wrap.bind('touchmove', function (e) {
                                if($('.fancybox-prev').is(':visible') || $('.fancybox-next').is(':visible')){
                                    e.preventDefault();
                                    if(moved_distance++ > 2){
                                        moved = true;
                                    }
                            ...
                            F.wrap.bind('touchstart', function (e) {
                                if($('.fancybox-prev').is(':visible') || $('.fancybox-next').is(':visible')){
                            ...
                            F.wrap.bind('touchend', function (e) {
                                if(moved){
                                    var touch = e.originalEvent.touches[0] || e.originalEvent.changedTouches[0];
                                    if(touch.pageX > tprev && $('.fancybox-prev').is(':visible')){
                                        F.prev();
                                    }else if($('.fancybox-next').is(':visible')){
                                        F.next();
                                    }
//                                    F[touch.pageX > tprev ? 'prev' : 'next']()
                                }
                                moved_distance = 0;
                                moved = false;
                            });
